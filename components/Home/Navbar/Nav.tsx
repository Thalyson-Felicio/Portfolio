...
const Nav = ({openNav}:Props) => {
  ...
  return <div className={`transition-all ${NavBg ? 'bg-[#0f142ed9] shadow-md' : 'fixe'} duration-200 h-[12vh] z-[10000] fixed w-full`}>
    <div className="flex items-center h-full justify-between w-[90%] mx-auto">
      ...
      <div className="flex items-center space-x-2">
        ...
        <h1 className="text-xl hidden sm:block md:text-2xl text-white font-bold">Thalyson</h1>
      </div>
      {/* navlinks */}
      ...
      <div className="flex items-center space-x-4">
        ...
        {/* Burguer Menu */}
        <HiBars3BottomRight onClick={openNav} className="w-8 h-8 text-white lg:hidden" />
      </div>
    </div>
  </div>
};
